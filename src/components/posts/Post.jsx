   ...
   return (
      <div className="postCard">
         ...
         <div className="likeUnlike">
            {loggedInUser &&
               <>
               <button onClick={() => likePost(data.id, loggedInUser.id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
               ...
               <button onClick={() => unlikePost(data.id, loggedInUser.id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
